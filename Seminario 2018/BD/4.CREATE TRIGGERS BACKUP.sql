...
FOR EACH ROW
BEGIN
	INSERT INTO BACKUP_AJKS.BACKUP_PASSAGEIRO_I VALUES(NULL, NEW.IDPASSAGEIRO,NEW.ID_DADOSPESSOAS, NEW.ID_VIAGEM, NOW(),CURRENT_USER(),'I');
END
$
