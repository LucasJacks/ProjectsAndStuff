...
CREATE  PROCEDURE ADICIONAR_E_PASSAGEIRO(
		  IN pIDVIAGENS INT ,
    ...
    ELSE
		...
		THEN
        	...
        	ELSE
          	  INSERT INTO VIAGENS (IDVIAGENS, CIDADE, DATAHORAINICIO, DATAHORAFINAL, COR, CEP, RUA, NUMERO, BAIRRO, ESTADO, DESCRICAO,  ID_MOTORISTA, ID_VIATURA)
